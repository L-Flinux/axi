	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="游戏分类" prop="youxifenlei">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="游戏标签" prop="youxibiaoqian">
					<el-input v-model="ruleForm.youxibiaoqian" placeholder="游戏标签" clearable  :readonly="ro.youxibiaoqian"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="游戏标签" prop="youxibiaoqian">
					<el-input v-model="ruleForm.youxibiaoqian" placeholder="游戏标签" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.shipinjieshao" label="视频介绍" prop="shipinjieshao">
					<file-upload
						tip="点击上传视频介绍"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.shipinjieshao" label="视频介绍" prop="shipinjieshao">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 15px","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"4px","background":"rgba(44, 55, 66, 0.8)","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.shipinjieshao)">预览</el-button>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="!ruleForm.shipinjieshao" label="视频介绍" prop="shipinjieshao">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="游戏详情" prop="youxixiangqing">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.youxixiangqing" label="游戏详情" prop="youxixiangqing">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.youxixiangqing = this.ruleForm.youxixiangqing.replace(reg,'../../../springboott9jh4c61/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
