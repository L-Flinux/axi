<template>
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231121/f1acd3cf548c43a1a7d4c22fff76b387.jpg)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='register'" :style='{"padding":"20px","boxShadow":"0 1px 6px rgba(64, 158, 255, .8)","margin":"50px 0","borderRadius":"10px","background":"#fff","width":"600px","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm" :rules="rules">
				<div v-if="true" :style='{"width":"100%","margin":"0 0 10px 0","lineHeight":"64px","fontSize":"30px","color":"rgba(44, 55, 66, 0.9)","textAlign":"center"}' class="title">基于Spring Boot的游戏推荐系统注册</div>
	...
	.container {
	  ...
	  background: url(http://codegen.caihongy.cn/20231121/f1acd3cf548c43a1a7d4c22fff76b387.jpg);
		...
		.rgs-form /deep/ .upload .upload-img {
		  		  border: 1px dashed rgba(44, 55, 66, 0.9);
		  		  cursor: pointer;
		  		  border-radius: 8px;
		  		  color: rgba(44, 55, 66, 0.9);
		  		  object-fit: cover;
