	...
	<div class="main-containers">
		...
		<div class="top-container" :style='{"boxShadow":"0 0px 0px rgba(64, 158, 255, .3)","padding":"12px 7% 0","borderColor":"#eee","alignItems":"center","color":"#666","textAlign":"right","display":"block","top":"0","left":"0","background":"#fff","borderWidth":"0px","width":"100%","fontSize":"14px","position":"inherit","borderStyle":"solid","height":"74px","zIndex":"1002"}'>
			...
			<div :style='{"padding":"0 8px","alignItems":"center","textAlign":"center","display":"flex","justifyContent":"center","top":"124px","borderRadius":"8px 0 0 8px","left":"calc(18% + 0px)","background":"#fff","width":"328px","position":"absolute","zIndex":"1002","height":"128px"}'>
			  <span :style='{"padding":"0px","lineHeight":"1.2","fontSize":"28px","color":"#7c3ef3","float":"left"}'>基于Spring Boot的游戏推荐系统</span>
			</div>
			...
			<div id="search" class="search" :style='{"margin":"0 10px","flexWrap":"wrap","background":"#fff","display":"none","height":"auto"}'>
				...
				<div :style='{"margin":"0 10px 0 0"}' class="input" v-if="queryIndex==0">
					<el-input v-model="youxixinxiyouximingcheng" placeholder="游戏名称"></el-input>
				</div>
				<div :style='{"margin":"0"}' class="btn" v-if="queryIndex==0">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"4px","background":"rgba(64, 158, 255, 1)","width":"auto","lineHeight":"44px","fontSize":"14px","height":"44px"}' type="primary" @click="search('youxixinxi')">
				...
				<div :style='{"margin":"0 10px 0 0"}' class="input" v-if="queryIndex==1">
					<el-input v-model="youxiwupinwupinmingcheng" placeholder="物品名称"></el-input>
				</div>
				<div :style='{"margin":"0"}' class="btn" v-if="queryIndex==1">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"4px","background":"rgba(64, 158, 255, 1)","width":"auto","lineHeight":"44px","fontSize":"14px","height":"44px"}' type="primary" @click="search('youxiwupin')">
						<span class="icon iconfont icon-fangdajing07" :style='{"color":"rgba(255, 255, 255, 1)","margin":"0 4px 0 0","fontSize":"14px"}'></span>
						搜索
					</el-button>
				</div>
			...
			<el-scrollbar wrap-class="scrollbar-wrapper-horizontal">
				<el-menu class="el-menu-horizontal-demo" :style='{"border":"0","padding":"0 20px 0 328px","listStyle":"none","margin":"0","alignItems":"space-between","borderRadius":"8px","background":"none","display":"flex","position":"relative"}' :default-active="activeMenu" :unique-opened="true" mode="horizontal" :router="true" @select="handleSelect">
					...
					<el-menu-item class="home" index="/index/home" @click.native="goMenu('/index/home')">
						...
						<span :style='{"padding":"0 10px","lineHeight":"128px","fontSize":"16px","color":"inherit","height":"128px"}'></span>
					</el-menu-item>
...
export default {
    data() {
		...
		queryIndex: 0,
		youxixinxiyouximingcheng: '',
		youxiwupinwupinmingcheng: '',
            activeIndex: '0',
			roleMenus: [{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","首页总数"],"appFrontIcon":"cuIcon-flashlightopen","buttons":["新增","查看","修改","删除","首页总数"],"menu":"用户","menuJump":"列表","tableName":"yonghu"}],"menu":"用户管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-newshot","buttons":["新增","查看","修改","删除"],"menu":"游戏分类","menuJump":"列表","tableName":"youxifenlei"}],"menu":"游戏分类管理"},{"child":[{"allButtons":["新增","查看","修改","删除","报名测试"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"游戏信息","menuJump":"列表","tableName":"youxixinxi"}],"menu":"游戏信息管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-flashlightopen","buttons":["新增","查看","修改","删除"],"menu":"游戏物品","menuJump":"列表","tableName":"youxiwupin"}],"menu":"游戏物品管理"},{"child":[{"allButtons":["新增","查看","修改","删除","审核","测试报名统计","首页总数","首页统计","测试反馈"],"appFrontIcon":"cuIcon-pay","buttons":["查看","修改","删除","审核","首页总数","首页统计"],"menu":"报名信息","menuJump":"列表","tableName":"baomingxinxi"}],"menu":"报名信息管理"},{"child":[{"allButtons":["新增","查看","修改","删除","审核","游戏时长统计","游戏评分统计","首页总数","首页统计"],"appFrontIcon":"cuIcon-rank","buttons":["查看","修改","删除","审核","首页总数","首页统计"],"menu":"测试反馈","menuJump":"列表","tableName":"ceshifankui"}],"menu":"测试反馈管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-group","buttons":["查看","修改","删除"],"menu":"论坛交流","tableName":"forum"}],"menu":"论坛交流"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"游戏资讯","tableName":"news"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"游戏资讯分类","tableName":"newstype"},{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-similar","buttons":["查看","修改"],"menu":"关于我们","tableName":"aboutus"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-copy","buttons":["查看","修改"],"menu":"轮播图管理","tableName":"config"}],"menu":"系统管理"},{"child":[{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","物流","退货审核"],"appFrontIcon":"cuIcon-vipcard","buttons":["品销额","品销量","查看","退货审核"],"menu":"已完成订单","tableName":"orders/已完成"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额"],"appFrontIcon":"cuIcon-cardboard","buttons":["查看"],"menu":"已取消订单","tableName":"orders/已取消"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","物流"],"appFrontIcon":"cuIcon-addressbook","buttons":["查看"],"menu":"已退款订单","tableName":"orders/已退款"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额"],"appFrontIcon":"cuIcon-attentionfavor","buttons":["查看"],"menu":"未支付订单","tableName":"orders/未支付"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","发货","物流","核销"],"appFrontIcon":"cuIcon-goodsnew","buttons":["核销","查看"],"menu":"已支付订单","tableName":"orders/已支付"}],"menu":"订单管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","报名测试"],"appFrontIcon":"cuIcon-circle","buttons":["查看","报名测试"],"menu":"游戏信息列表","menuJump":"列表","tableName":"youxixinxi"}],"menu":"游戏信息模块"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-explore","buttons":["查看"],"menu":"游戏物品列表","menuJump":"列表","tableName":"youxiwupin"}],"menu":"游戏物品模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"管理员","tableName":"users"},{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","审核","测试报名统计","首页总数","首页统计","测试反馈"],"appFrontIcon":"cuIcon-pay","buttons":["查看","测试反馈"],"menu":"报名信息","menuJump":"列表","tableName":"baomingxinxi"}],"menu":"报名信息管理"},{"child":[{"allButtons":["新增","查看","修改","删除","审核","游戏时长统计","游戏评分统计","首页总数","首页统计"],"appFrontIcon":"cuIcon-rank","buttons":["查看"],"menu":"测试反馈","menuJump":"列表","tableName":"ceshifankui"}],"menu":"测试反馈管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","报名测试"],"appFrontIcon":"cuIcon-circle","buttons":["查看","报名测试"],"menu":"游戏信息列表","menuJump":"列表","tableName":"youxixinxi"}],"menu":"游戏信息模块"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-explore","buttons":["查看"],"menu":"游戏物品列表","menuJump":"列表","tableName":"youxiwupin"}],"menu":"游戏物品模块"}],"hasBackLogin":"否","hasBackRegister":"否","hasFrontLogin":"是","hasFrontRegister":"是","roleName":"用户","tableName":"yonghu"}],
			baseUrl: '',
			carouselList: [],
			menuList: [],
			form: {
    ...
    mounted() {
		...
		// banner
		setTimeout(()=>{
			new Swiper(".mySwiper3", {"navigation":{"nextEl":".swiper-button-next","prevEl":".swiper-button-prev"},"pagination":{"el":".swiper-pagination","clickable":true},"autoplay":{"delay":2500,"disableOnInteraction":false},"effect":"flip"})
		}, 500)
    ...
    methods: {
      search(tablename) {
        if (this.queryIndex == 0 && this.youxixinxiyouximingcheng) {
          this.$router.push({path: '/index/' + tablename, query: {indexQueryCondition: this.youxixinxiyouximingcheng}});
        }
        if (this.queryIndex == 1 && this.youxiwupinwupinmingcheng) {
          this.$router.push({path: '/index/' + tablename, query: {indexQueryCondition: this.youxiwupinwupinmingcheng}});
        }
      },
...
<style rel="stylesheet/scss" lang="scss" scoped>
	...
	.menu-preview .el-menu-horizontal-demo .el-menu-item.home {
				...
				font-size: 16px;
				line-height: 128px;
				background: url(http://codegen.caihongy.cn/20231026/98d54a543bed4b2fa8d71691edf524d0.png) no-repeat center center,#7c3ef3;
				width: 100px;
