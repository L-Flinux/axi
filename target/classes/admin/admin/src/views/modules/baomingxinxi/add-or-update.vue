	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="报名日期" prop="baomingriqi">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.baomingriqi" label="报名日期" prop="baomingriqi">
					<el-input v-model="ruleForm.baomingriqi" placeholder="报名日期" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="报名内容" prop="baomingneirong">
					<el-input v-model="ruleForm.baomingneirong" placeholder="报名内容" clearable  :readonly="ro.baomingneirong"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="报名内容" prop="baomingneirong">
